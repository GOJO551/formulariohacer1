...
<%--imporamos una liberia en Map--%>
<%@page import="java.util.Map" %>
<%--Incluimos un scriplet para llamar los errores --%>
<%
...
<%-- Implementamos una condicion para saber si exite errores o no --%>
<%
...
<div>
    <form action="/Formulario3/ingresar" method="post">
        <div>
